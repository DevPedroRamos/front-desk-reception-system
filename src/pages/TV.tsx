  ...
  return (
    <div className="min-h-screen bg-muted/30">
        ...
        <div className="relative z-10 px-8 py-6">
          <div className="flex justify-between items-center mb-8">
            <div className="flex items-center gap-4">
              <div className="text-2xl font-bold">METROCASA</div>
      ...
      <div className="px-8 py-6 -mt-8 relative z-20">
        ...
        {/* Banner Promocional */}
        <Card className="shadow-xl border-0 bg-gradient-to-r from-primary via-primary/90 to-primary text-primary-foreground overflow-hidden">
        ...
        <div className="mt-12 text-center">
          ...
          <p className="text-muted-foreground mb-12 text-lg">Entenda o processo de monitoramento em tempo real</p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="shadow-lg border-0 bg-card hover:shadow-xl transition-shadow">
            ...
            <Card className="shadow-lg border-0 bg-card hover:shadow-xl transition-shadow">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground">
                  Alcance resultados extraordinários com base nos insights obtidos
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <footer className="bg-secondary text-secondary-foreground mt-16">
        <div className="px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="text-2xl font-bold text-primary mb-4">METROCASA</div>
              <p className="text-muted-foreground">Construindo sonhos, criando histórias.</p>
            </div>
            <div>
